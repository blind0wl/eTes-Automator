        ...
        public async static Task StartTimesheet()
        {
            ...
            try
            {
                ...
                if (dayoftheweek >= 1 && dayoftheweek <= 5) //&& currentDateTime.Hour < 17)
                {
                    ...
                    //Create Lists for the settings.ini hours and pull the current filled data on the website
                    List<string> dayArray = new List<string>();
                    List<string> hoursArray = new List<string>();
                    //Create List of the button names (the text box areas of the etes webpage where time value is entered
